...
//            user.firstName = regFirstName.text.toString().trim()
            user.firstName = (regFirstName.text.toString().trim()[0].toUpperCase()+regFirstName.text.toString().trim().substring(1))
//            user.lastName = regLastName.text.toString().trim()
            user.lastName = (regLastName.text.toString().trim()[0].toUpperCase()+regLastName.text.toString().trim().substring(1))
